...
//                                    "onPayloadTransferUpdate(endpointId=%s, update=%d)", endpointId, update.getBytesTransferred()));
        ...
        if (requestCode == REQUEST_CODE_REQUIRED_PERMISSIONS) {
            for (int grantResult : grantResults) {
                if (grantResult == PackageManager.PERMISSION_DENIED) {
                    Toast.makeText(this, R.string.pm_error_missing_permissions, Toast.LENGTH_LONG).show();
                    finish();
                    return;
                }
            }
        ...
        Nearby.Connections.startDiscovery(
                ...
                new EndpointDiscoveryCallback() {
                    ...
                    public void onEndpointFound(String endpointId, DiscoveredEndpointInfo info) {
                        ...
                        if (getServiceIdToDiscover().equals(info.getServiceId())) {
     ...
     * them.
     */
    protected abstract String getServiceIdToDiscover();
    ...
    public static final String TAG = "PmCoreShareContact";
