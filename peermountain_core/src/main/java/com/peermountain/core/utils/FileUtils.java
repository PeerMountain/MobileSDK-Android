...
/**
 * Created by Galeen on 27.11.2015 г..
 */
/*
...
public class FileUtils {
    ...
    public static boolean isLocalStorageDocument(Context context, Uri uri) {
        return  (context.getPackageName()+ ".localstorage.documents").equals(uri.getAuthority());
    }
...
//            }else return;
    ...
    private static class CopyFiles extends AsyncTask<Void,Void, Boolean>{
        ...
        private CopyFiles(File sourceFile, File destFile, CopyFileEvents callback, boolean deleteSource) {
