...
//
//        final InvitationBody invitationBody = new InvitationBody();
//        invitationBody.inviteMsgID = ""; // result['data']['sendMessage']['messageHash']
//        invitationBody.keyProof = ""; // inviteKey encrypted by the deployment machine persona publicKey
//        invitationBody.inviteName = invitation.getInviteName();
//        invitationBody.publicKey = invitation.getInviteKey();
//        invitationBody.publicNickname = "Futurist";
