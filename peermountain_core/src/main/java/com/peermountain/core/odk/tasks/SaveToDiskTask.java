...
import com.peermountain.core.odk.utils.EncryptionUtils;
...
public class SaveToDiskTask extends AsyncTask<Void, String, SaveResult> {
    ...
    protected SaveResult doInBackground(Void... nothing) {
        ...
        publishProgress(getString(R.string.survey_saving_validating_message));
...
//        }
    ...
    private void exportData(boolean markCompleted) throws IOException, EncryptionException {
        ...
        publishProgress(getString(R.string.survey_saving_collecting_message));

        ByteArrayPayload payload = formController.getFilledInFormXml();
        // write out xml
        String instancePath = formController.getInstancePath().getAbsolutePath();

        publishProgress(getString(R.string.survey_saving_saving_message));
        ...
        if (markCompleted) {
            ...
            publishProgress(getString(R.string.survey_saving_finalizing_message));
            ...
            if (formInfo != null) {
                ...
                publishProgress(getString(R.string.survey_saving_encrypting_message));
    ...
    private String getString(int res) {
        return PeerMountainManager.getApplicationContext().getString(res);
    }
