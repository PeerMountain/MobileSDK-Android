    ...
    public static class AudioHandler {
        ...
        public void playAudio(Context c) {
            if (uri == null) {
                ...
                ToastUtils.showLongToast(R.string.pm_audio_file_error);
                return;
            }
            ...
            if (!audioFile.exists()) {
                ...
                String errorMsg = c.getString(R.string.pm_file_missing, audioFile);
                Timber.e(errorMsg);
            ...
            try {
                ...
                String errorMsg = c.getString(R.string.pm_audio_file_invalid, audioFilename);
                Timber.e(errorMsg);
                ToastUtils.showLongToast(errorMsg);
            }
